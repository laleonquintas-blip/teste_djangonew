...
# REMOVIDO "RASCUNHO" DA LISTA VISUAL
STATUS_WORKFLOW = [
...
FORMA_PAGTO_CHOICES = [('PIX', 'Pix'), ('BANCO', 'Transferência Bancária')]
...
class Despesa(models.Model):
    ...
    # STATUS: Note que o default ainda pode ser RASCUNHO internamente se precisar,
    # mas a lista de escolha não mostra mais.
    ...
    motivo_ausencia = models.ForeignKey(MotivoAusencia, on_delete=models.SET_NULL, null=True, blank=True,
                                        verbose_name="Motivo Ausência")
    colaborador_faltou = models.ForeignKey(Colaborador, on_delete=models.SET_NULL, null=True, blank=True,
                                           related_name='faltas_workflow', verbose_name="Colaborador que Faltou")

    nome_cobriu = models.CharField(max_length=150, blank=True, verbose_name="Nome de Quem Cobriu")
    forma_pagamento = models.CharField(max_length=10, choices=FORMA_PAGTO_CHOICES, blank=True,
    ...
    # --- NOVO CAMPO: OPERADOR RESPONSÁVEL ---
